public class SistemaLinearGaussJacobi {
    public static void main(String[] args) {
        ...
        double[] solution = SistemaLinearGaussJacobi(A, b, initialGuess, tol, maxIter);
    ...
    public static double[] SistemaLinearGaussJacobi(double[][] A, double[] b, double[] initialGuess, double tol, int maxIter) {
        int n = A.length;
